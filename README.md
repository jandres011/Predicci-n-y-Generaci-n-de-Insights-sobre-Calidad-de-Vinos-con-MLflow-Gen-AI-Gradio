...
Objetivo: Calidad del vino (escala entera de 0 a 10)
...
La explicación se registra automáticamente como artefacto en MLflow.

Entrega Final
Este repositorio incluye todos los artefactos requeridos:

Código fuente modular y reproducible
Notebook de exploración de datos
Interfaz Gradio funcional
Capturas de MLflow UI (en el informe)
Video demo (demo.mp4)
Informe PDF con metodología, resultados y reflexión ética sobre el uso de Gen AI
Autores
